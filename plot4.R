...
plot(datetime, energyusage$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datetime, energyusage$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, energyusage$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
